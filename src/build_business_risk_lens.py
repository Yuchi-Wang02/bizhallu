...
<div style="overflow-x:auto"><table><caption>Historical eligible ledger; category assignments use a stock-code heuristic</caption><thead><tr><th>Category</th><th>Lines</th><th>Positive</th><th>Negative</th><th>Net</th></tr></thead><tbody>{categories}</tbody></table></div>
...
<p>No new model run or 10-20-question expansion is scheduled by this page. Near-term work is consistency, explanation and a small SQL/BI companion under the semester plan; research expansion remains conditional.</p></section>

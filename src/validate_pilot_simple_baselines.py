...
CONFUSION_PATH = RESULTS_DIR / "confusion_matrices" / "pilot20_simple_baselines_confusion_matrices.csv"
REPORT_PATH = RESULTS_DIR / "pilot20_simple_baseline_report.json"
VALIDATION_PATH = RESULTS_DIR / "pilot20_simple_baseline_validation.json"

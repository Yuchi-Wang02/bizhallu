...
REQUIRED_FRAGMENTS = [
    ...
    "outcome-blind context manifest and 6/15/27 split are frozen under a public SHA-256 commitment",
    "No question, gold answer, prompt, model output, annotation, detector score, or new empirical metric exists",

...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Historical label-derived claim-evidence review schema for 15 selected BizHallu spans. A protocol scaffold, not an independent verifier.">
    <style>
      :root {{
        --bg: #f6f7f9;
        --surface: #ffffff;
      ...
      * {{ box-sizing: border-box; }}
      ...
      .site-nav {{ width: min(1180px, calc(100% - 40px)); margin: auto; padding: 16px 0; display: flex; flex-wrap: wrap; align-items: center; gap: 8px 20px; border-bottom: 1px solid var(--line); font-size: 14px; }}
      .site-nav .brand {{ margin-right: auto; color: var(--ink); }}
      .site-nav a {{ min-height: 36px; display: inline-flex; align-items: center; }}
      main {{ width: min(1180px, calc(100% - 40px)); margin: 0 auto; }}
      header {{ padding: 28px 0; }}
      h1 {{ max-width: 880px; margin: 0; font-size: 30px; line-height: 1.2; letter-spacing: 0; }}
      ...
      @media (max-width: 900px) {{
        ...
        .site-nav {{ width: min(100% - 28px, 720px); }}
  ...
  <body>
    ...
    <nav class="site-nav" aria-label="Primary"><a class="brand" href="./index.html">BizHallu</a><a href="./index.html">Home</a><a href="./portfolio_demo_v2.html">Cases</a><a href="./detector_interpretation.html">Methods</a><a href="./research_one_pager.html">Research</a><a href="https://github.com/Yuchi-Wang02/bizhallu">GitHub</a></nav>
    <main id="main">
      <header>
        <p class="eyebrow">Claim-evidence review schema v0</p>
        <h1>A historical schema for claim-evidence review.</h1>
        <p class="lede">
      ...
      <section class="section">
        ...
        <div class="table-scroll" role="region" aria-label="Historical label-derived review rows" tabindex="0"><table>
          <thead>
            <tr>
              <th scope="col">Question</th>
              <th scope="col">Fact type</th>
              <th scope="col">Derived review status</th>
              <th scope="col">Span</th>
              <th scope="col">Generated claim line</th>
              <th scope="col">Detector outcomes</th>
              <th scope="col">Protocol note</th>
            </tr>
          </thead>
          <tbody>
            {rows_html}

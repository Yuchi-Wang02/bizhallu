...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Inspect original retail-analysis answers and evidence rows. BizHallu's curated cases distinguish correct amount copying from incorrect business relationships.">
    <style>
      :root {{
        --bg: #f6f7f9;
        --surface: #ffffff;
      ...
      * {{ box-sizing: border-box; letter-spacing: 0; }}
      ...
      a:focus-visible, button:focus-visible, select:focus-visible, summary:focus-visible, [tabindex]:focus-visible {{ outline: 3px solid var(--blue); outline-offset: 4px; border-radius: 3px; }}
      ...
      @media (max-width: 560px) {{
        ...
        .nav {{ justify-content: flex-start; gap: 6px 14px; }}
      }}
    </style>
  </head>
  <body>
    ...
    <header class="topbar">
      ...
      <nav class="nav" aria-label="Primary">
        ...
        <a href="./portfolio_demo_v2.html" aria-current="page">Cases</a>

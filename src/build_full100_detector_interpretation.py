...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Methods and limits of BizHallu's exploratory span-level evaluation: provisional labels, dev thresholds, simple references and statistical sensitivity.">
    <style>
      :root {{
        --bg: #f5f5f7;
      ...
      * {{ box-sizing: border-box; }}
      ...
      a:focus-visible, summary:focus-visible, [tabindex]:focus-visible {{ outline: 3px solid var(--blue); outline-offset: 4px; border-radius: 3px; }}
      .skip-link {{ position: absolute; top: -100px; left: 16px; z-index: 30; padding: 12px; background: #fff; }}
      ...
      .nav a[aria-current="page"] {{ font-weight: 750; text-decoration: underline; text-underline-offset: 5px; }}
      main p a, main li a {{ color: var(--blue); text-decoration: underline; text-underline-offset: 3px; }}
      .topbar {{
        position: sticky;
        top: 0;
        z-index: 5;
      ...
      @media (max-width: 560px) {{
        .topbar {{ position: static; padding: 12px 16px; flex-wrap: wrap; gap: 8px; }}
        .nav {{ flex-wrap: wrap; gap: 6px 14px; }}
  ...
  <body>
    ...
    <header class="topbar">
      ...
      <nav class="nav" aria-label="Primary">
        ...
        <a href="./portfolio_demo_v2.html">Cases</a>
        <a href="./detector_interpretation.html" aria-current="page">Methods</a>
    ...
    <main id="main">
      <section class="hero">
        <div>
          ...
          <p class="lede">
            The historical token-signal comparison is exploratory. B1 adds simple reference predictions
            and paired uncertainty; B2 checks a dev-annotation omission. Candidate winners were selected
...
{metric_cards}
      ...
      <section class="next">
        <div>
          ...
          <h2>Define the relationship before comparing detectors.</h2>
          <p class="lede">
            A useful next comparison needs a clear relation annotation unit, independent judgments and
            matched information availability. Fifteen selected presentation spans received additional
            assistant review; the original 205-span package remains AI-assisted and provisional, with no
            independent human annotation or inter-annotator agreement.
          </p>
          <p><a href="./portfolio_demo_v2.html?case=q_0064">Return to the April example</a> · <a href="../results/full100_draft_detector_error_review_examples.csv">Inspect historical error examples</a></p>
        </div>
        <a class="button" href="./research_one_pager.html">Research questions</a>
      </section>
      <details><summary>Historical annotation record</summary><p><a href="./full100_label_confirmation_packet.html">Selected-span assistant review packet</a>. This earlier record is retained for provenance and is not independent human annotation.</p></details>
    </main>
  </body>
</html>
"""

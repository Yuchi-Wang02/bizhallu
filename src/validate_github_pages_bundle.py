...
REQUIRED_INDEX_FRAGMENTS = [
    ...
    "36/36 unique period-to-family matching",
    "three allowed families",
    "No context assignment, split, prompt, model output, or new metric exists.",
...
def main() -> None:
    ...
    expected_manifest_values = {
        ...
        "confirmation_required_context_count": 36,
        "confirmation_maximum_slot_matching_count": 36,
        "confirmation_minimum_hall_capacity_slack": 14,

...
REQUIRED_INDEX_FRAGMENTS = [
    ...
    "No context assignment, split, question, prompt, model output, annotation, or new empirical metric exists.",
    "6/15/27 context-manifest",
...
def main() -> None:
    ...
    expected_manifest_values = {
        ...
        "confirmation_context_manifest_created": False,
